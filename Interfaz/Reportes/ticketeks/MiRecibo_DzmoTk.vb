...
Public Class MiRecibo_DzmoTk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.MiRecibo_DzmoTk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMiRecibo_DzmoTk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MiRecibo_DzmoTk = New MiRecibo_DzmoTk()
        rpt.Site = Me.Site
        Return rpt
    End Function
