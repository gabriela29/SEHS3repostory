...
Public Class MiRecibo_InternoTk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.MiRecibo_InternoTk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMiRecibo_InternoTk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MiRecibo_InternoTk = New MiRecibo_InternoTk()
        rpt.Site = Me.Site
        Return rpt
    End Function
