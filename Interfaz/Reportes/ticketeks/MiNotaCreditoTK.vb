...
Public Class MiNotaCreditoTK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.MiNotaCreditoTK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMiNotaCreditoTK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MiNotaCreditoTK = New MiNotaCreditoTK()
        rpt.Site = Me.Site
        Return rpt
    End Function
