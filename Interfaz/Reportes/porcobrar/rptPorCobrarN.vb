...
Public Class rptPorCobrarN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptPorCobrarN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPorCobrarN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPorCobrarN = New rptPorCobrarN()
        rpt.Site = Me.Site
        Return rpt
    End Function
