...
Public Class rptResumen_cxc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptResumen_cxc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumen_cxc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumen_cxc = New rptResumen_cxc()
        rpt.Site = Me.Site
        Return rpt
    End Function
