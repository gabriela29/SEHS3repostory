...
Public Class rptPorCobrar_Ndias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptPorCobrar_Ndias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPorCobrar_Ndias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPorCobrar_Ndias = New rptPorCobrar_Ndias()
        rpt.Site = Me.Site
        Return rpt
    End Function
