...
Public Class rptStock_Valorado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptStock_Valorado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStock_Valorado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStock_Valorado = New rptStock_Valorado()
        rpt.Site = Me.Site
        Return rpt
    End Function
