...
Public Class rptGestionCobrabza
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptGestionCobrabza.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGestionCobrabza
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGestionCobrabza = New rptGestionCobrabza()
        rpt.Site = Me.Site
        Return rpt
    End Function
