...
Public Class rptPagosColportaje
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptPagosColportaje.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPagosColportaje
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagosColportaje = New rptPagosColportaje()
        rpt.Site = Me.Site
        Return rpt
    End Function
