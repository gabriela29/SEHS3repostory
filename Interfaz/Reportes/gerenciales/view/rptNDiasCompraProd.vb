...
Public Class rptNDiasCompraProd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptNDiasCompraProd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNDiasCompraProd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNDiasCompraProd = New rptNDiasCompraProd()
        rpt.Site = Me.Site
        Return rpt
    End Function
