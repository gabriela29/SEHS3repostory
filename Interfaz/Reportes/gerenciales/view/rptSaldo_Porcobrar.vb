...
Public Class rptSaldo_Porcobrar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptSaldo_Porcobrar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaldo_Porcobrar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaldo_Porcobrar = New rptSaldo_Porcobrar()
        rpt.Site = Me.Site
        Return rpt
    End Function
