...
Public Class rptClasificacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptClasificacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClasificacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClasificacion = New rptClasificacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
