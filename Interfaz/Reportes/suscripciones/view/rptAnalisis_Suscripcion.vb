...
Public Class rptAnalisis_Suscripcion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAnalisis_Suscripcion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptAnalisis_Suscripcion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xComentario() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptAnalisis_Suscripcion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAnalisis_Suscripcion = New rptAnalisis_Suscripcion()
        rpt.Site = Me.Site
        Return rpt
    End Function
