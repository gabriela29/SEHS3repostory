...
Public Class RptArqueo_Caja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.RptArqueo_Caja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptArqueo_Caja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptArqueo_Caja = New RptArqueo_Caja()
        rpt.Site = Me.Site
        Return rpt
    End Function
