...
Public Class rptAsiento_CV
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptAsiento_CV.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAsiento_CV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAsiento_CV = New rptAsiento_CV()
        rpt.Site = Me.Site
        Return rpt
    End Function
