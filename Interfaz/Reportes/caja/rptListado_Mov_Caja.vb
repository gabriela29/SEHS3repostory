...
Public Class rptListado_Mov_Caja
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptListado_Mov_Caja.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptListado_Mov_Caja.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xCaja() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptListado_Mov_Caja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListado_Mov_Caja = New rptListado_Mov_Caja()
        rpt.Site = Me.Site
        Return rpt
    End Function
