...
Public Class rptVenta_Costo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix.rptVenta_Costo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVenta_Costo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVenta_Costo = New rptVenta_Costo()
        rpt.Site = Me.Site
        Return rpt
    End Function
