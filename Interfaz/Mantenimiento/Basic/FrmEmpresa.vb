...
Public Class FrmEmpresa
    ...
    Private Sub FrmEmpresa_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Function ListarCondicion() As Boolean
        ...
        Try
            ListadoRegistros = empresaManager.GetList(Trim(Me.txtNomE.Text), txtRUC.Text, "", vArray, xLimit, 0)
