...
Public Class FrmActualizar_Item_Boleteo
    ...
    Private Sub BtnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGrabar.Click
        ...
        If gQue_Form_Llama = "BOLETEO_BLK" Then
            ...
            If FrmBoleteo_Bloque.Agregar_Producto(pCodigo_Producto, lblProducto.Text, Single.Parse(txtCantidad.Text), Single.Parse(txtPrecio.Text), _
                                                     Single.Parse(txtDscto.Text), 0, Me.pAfecto_IGV, pNuevo, 0, 0, False, 0) = False Then
                MsgBox("El producto ya esta registrado en el documento. . .", vbInformation, "Información")
                txtCantidad.Focus()
                Exit Sub
            End If

            FrmBoleteo_Bloque.txtBuscar.Focus()
            Me.Close()
        End If
    End Sub
