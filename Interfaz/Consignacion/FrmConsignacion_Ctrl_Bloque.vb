...
Public Class FrmConsignacion_Ctrl_Bloque
  ...
  Private Sub FrmConsignacion_Ctrl_Bloque_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    Call llenar_combos()
  ...
  Private Sub bwLlenar_Res_DoWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bwLlenar_Res.DoWork
    ...
    DtRes = consignacionManager.Leer_Consignacion_Res(xCod_uni, xCod_Alm, 0, 0, 0, "", "", "", 2)
    e.Result = DtRes
  ...
  Private Sub bwLlenar_Detalle_DoWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bwLlenar_Detalle.DoWork
    ...
    DtColp = consignacionManager.Leer_Consignacion(xCod_uni, xCod_Alm, 0, _codigo, 0, "", "", "", 2)
  ...
  Private Sub tsActualizar_Res_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    picAjaxRes.Visible = True
    gpCriterios.Enabled = False
    'gpBotones.Enabled = False
    dgvListado.DataSource = Nothing
  ...
  Private Sub tsAgregar_Consignacion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsAgregar_Consignacion.Click
    ...
    Call LibreriasFormularios.Ver_Form(frm, "Actualizar Consgin Blk")
  End Sub

  Private Sub tsdDetalle_Doc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsdDetalle_Doc.Click
    If dgvListado.Rows.Count > 0 Then
      If dgvListado.Selected.Rows.Count > 0 Then
  ...
  Private Sub tsmnuRptStock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsmnuRptStock.Click
    If dgvResumen.Rows.Count > 0 Then
      If dgvResumen.Selected.Rows.Count > 0 Then
        ...
        dtTemp = reportes_consignacionManager.rptStock(cboAlmacen.Value, tCodigo, vDesde, vHasta, 2, "", 0)

        Dim frm As New FrmVisor_Consignacion

        frm.RptStock(dtTemp, GestionSeguridadManager.gEmpresa, cboAlmacen.Text, "Stock Consignación Individual", vCond)
        Call LibreriasFormularios.Ver_Form(frm, "Stock Consig.")
      End If
    End If
  End Sub
  ...
  Private Sub tsmnAddConsignacion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsmnAddConsignacion.Click
    ...
    With frm
      ...
      .pNombre_Almacen = cboAlmacen.Text
    End With
    Call LibreriasFormularios.Ver_Form(frm, "Actualizar Consig.")
  ...
  Private Sub tsmnBoletear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsmnBoletear.Click
    If dgvResumen.Rows.Count > 0 Then
      If dgvResumen.Selected.Rows.Count > 0 Then
        ...
        tCodigo = Long.Parse((dgvResumen.DisplayLayout.ActiveRow.Cells(0).Value))
        If tCodigo > 0 Then
          Dim frm As New FrmBoleteo_Bloque
          frm.pCodigo_Asis = tCodigo
          frm.pCodigo_Per = tCodigo
          frm.pCodigo_Almacen = cboAlmacen.Value
  ...
  Private Sub tsGuiaDuplicado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsGuiaDuplicado.Click
    If dgvListado.Rows.Count > 0 Then
      If dgvListado.Selected.Rows.Count > 0 Then
        ...
        Call LibreriasFormularios.Ver_Form(frm, "Duplicado Consig")
  ...
  Private Sub tsBoletas_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsBoletas.Click
    Dim frm As New FrmFacturacion_Consignacion
    frm.pRef = "BCD"
    Call LibreriasFormularios.Ver_Form(frm, "Facturación Consig. Blk")
  End Sub
  ...
  Private Sub tsDetExcel_Click(sender As Object, e As EventArgs) Handles tsDetExcel.Click
    Call LibreriasFormularios.Exportar_UltraGrid_Excel(dgvListado, utExcel, "ConsignacionB.xls")
  End Sub

  Private Sub tsmnuRptStock1_Click(sender As Object, e As EventArgs) Handles tsmnuRptStock1.Click
    If dgvResumen.Rows.Count > 0 Then
      If dgvResumen.Selected.Rows.Count > 0 Then
        Dim dtTemp As New DataTable, tCodigo As Long = 0, vHasta As String = "", vCond As String = "", vDesde As String = ""
        If chkRango.Checked Then
        ...
        tCodigo = Long.Parse((dgvResumen.DisplayLayout.ActiveRow.Cells(0).Value))
        vCond = "Hasta : " & cboHasta.Value
        dtTemp = reportes_consignacionManager.rptStock(cboAlmacen.Value, tCodigo, vDesde, vHasta, 2, "SOLOSALDO", 0)
