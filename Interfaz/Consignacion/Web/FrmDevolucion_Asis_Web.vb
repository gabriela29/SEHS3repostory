...
Public Class FrmDevolucion_Asis_Web
  ...
  Private Sub FrmDevolucion_Asis_Web_Load(sender As Object, e As EventArgs) Handles Me.Load
    Call llenar_combos()
  End Sub
  ...
  Private Sub bwPendiente_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwPendiente.DoWork
    Try
      ...
      dtT = devolucionasiswebManager.Leer_Dev_Asis_Pendiente(cboAlmacen.Value, cboAlmacen.Value, cboAsistente.Value, "", "", False, vPendiente)
      e.Result = dtT
    Catch ex As Exception
      MsgBox(ex.Message)
    End Try
  ...
  Private Sub tsDetalle_Pendiente_Click(sender As Object, e As EventArgs) Handles tsDetalle_Pendiente.Click
    If dgvListado.Rows.Count > 0 Then
      If dgvListado.Selected.Rows.Count > 0 Then
        ...
        frm.RptDetalle_Pedido(dtTemp, GestionSeguridadManager.gEmpresa, cboAlmacen.Text, "Detalle Devolución Consignación Nro: " & tCodigo.ToString)
        Call LibreriasFormularios.Ver_Form(frm, "Detalle Dev. C. Web.")
      End If
    End If
  End Sub
        ...
        If _Estado Then
          If _Cerrado Then
            If FrmAdd Is Nothing Then
              ...
              Dim yForm As New FrmDevolver_Asis_Web
              ...
              yForm.pCodigo = vCodigo
              yForm.pCodigo_Alm = cboAlmacen.Value
              yForm.pNombre_Almacen = cboAlmacen.Text
              yForm.pCodigo_Asis = vAsistenteId
              yForm.pNom_Asistente = vAsistente
              yForm.Show()
            Else
              FrmAdd.Show()
            End If
