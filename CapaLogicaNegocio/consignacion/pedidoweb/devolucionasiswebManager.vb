...
Namespace Bll
  Public Class devolucionasiswebManager
    Public Shared Function Leer_Dev_Asis_Pendiente(ByVal vCampania As Integer, ByVal vAlmacen As Integer, ByVal vPersona As Long,
      ...
      Return devolucionasiswebBD.Leer_Dev_Asis_Pendiente(vCampania, vAlmacen, vPersona, vDesde, vHasta, vEs_NC, vPendiente)
    End Function
    ...
    Public Shared Function Cambiar_Cerrado(ByVal vSuscripcionID As Long, ByVal vUsuario As Long, ByVal vCaja As String) As Boolean
      ...
      Try
        rs = devolucionasiswebBD.Cambiar_Cerrado(vSuscripcionID, vUsuario, vCaja)
        'outerrornumber
