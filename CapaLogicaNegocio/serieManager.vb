...
Namespace Bll
    Public Class serieManager
        ...
        Public Shared Function GetList(ByVal Descripcion As String) As DataTable
            Return serieBD.GetList(Descripcion)
        End Function

        Public Shared Function GetList(ByVal cod_Emp As Integer, ByVal Tipo_Doc As Integer) As DataTable
            Return serieBD.GetList(cod_Emp, Tipo_Doc)
        End Function

        Public Shared Function GetItem(ByVal codigo As Integer) As serie
            Return serieBD.GetItem(codigo)
        End Function
