...
Namespace Bll
    ...
    Public Class grupoManager
        ...
        Public Shared Function GetList(ByVal vNombre As String) As DataTable
            Return grupoBD.GetList(vNombre)
        End Function

        Public Shared Function GetItem(ByVal grupoId As Long) As grupo
            Return grupoBD.GetItem(grupoId)
        End Function

        Public Shared Function Grabar(ByRef objgrupo As grupo) As Long
            Dim rs As DataTable, vCodigo As Long
            vCodigo = 0
            Try
                rs = grupoBD.Grabar(objgrupo)
