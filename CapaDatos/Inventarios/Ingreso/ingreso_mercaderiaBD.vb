...
Namespace Dal
    Public Class ingreso_mercaderiaBD
        Public Shared Function Leer(ByVal vAlmacen As Integer, ByVal vdocumento As Integer, ByVal vPersona As Long, ByVal vrazsoc As String, ByVal vdesde As String, ByVal vhasta As String, ByVal vlimite As Integer) As DataTable
            ...
            Dim oSP As New clsStored_Procedure("inventarios.paingreso_mercaderia_leer")
        ...
        Public Shared Function Cambiar_Estado(ByVal vCodigo As Long, ByVal vUsuario As String, ByVal vCaja As String) As DataTable
            Dim TempList As New DataTable
            Dim oSP As New clsStored_Procedure("inventarios.paingreso_mercaderia_cambiar_estado")
            Dim oConexion As New clsConexion
            Try
        ...
        Public Shared Function Cambiar_Cierre(ByVal vCodigo As Long, ByVal vUsuario As String, ByVal vCaja As String) As DataTable
            Dim TempList As New DataTable
            Dim oSP As New clsStored_Procedure("inventarios.paingreso_mercaderia_cambiar_cierre")
            Dim oConexion As New clsConexion
            Try
                oSP.addParameter("vcodigo", vCodigo, NpgsqlTypes.NpgsqlDbType.Integer, 4, ParameterDirection.Input)
                oSP.addParameter("vusuario", vUsuario, NpgsqlTypes.NpgsqlDbType.Varchar, 20, ParameterDirection.Input)
        ...
        Public Shared Function Cambiar_Estado_Descontar(ByVal vCodigo As Long, ByVal vUsuario As String, ByVal vCaja As String) As DataTable
            Dim TempList As New DataTable
            Dim oSP As New clsStored_Procedure("inventarios.paingreso_mercaderia_cambiar_estado_descontar")
            Dim oConexion As New clsConexion
            Try
                oSP.addParameter("vcodigo", vCodigo, NpgsqlTypes.NpgsqlDbType.Integer, 4, ParameterDirection.Input)
                oSP.addParameter("vusuario", vUsuario, NpgsqlTypes.NpgsqlDbType.Varchar, 20, ParameterDirection.Input)
        ...
        Public Shared Function Eliminar(ByVal vCodigo As Long, ByVal vUsuario As Long, ByVal vCaja As String) As DataTable
            Dim TempList As New DataTable
            Dim oSP As New clsStored_Procedure("inventarios.paingreso_mercaderia_eliminar")
            Dim oConexion As New clsConexion
            Try
                oSP.addParameter("vcodigo", vCodigo, NpgsqlTypes.NpgsqlDbType.Integer, 4, ParameterDirection.Input)
        ...
        Public Shared Function Agregar(ByRef objIM As ingreso_mercaderia, ByVal myArr As String) As DataTable
            Dim vCadena As String = "", xNew As Boolean = True
            If objIM.ingmerid > 0 Then
                xNew = False
            End If
            Try
                vCadena = "select * from inventarios.paingreso_mercaderia_actualizar(" & xNew & ","
                vCadena = vCadena & " " & Trim(Str(objIM.ingmerid)) & ","
                vCadena = vCadena & " " & Trim(Str(objIM.tipomovmerid)) & ","
        ...
        Public Shared Function Agregar_NC(ByRef objIM As ingreso_mercaderia, ByVal myArr As String) As DataTable
            Dim vCadena As String = ""
            Dim xNew As Boolean = False
            Try

                vCadena = "select * from paingreso_mercaderia_actualizar_nc(true,0,"
        ...
        Public Shared Function Agregar_Transferencia(ByVal vCodigo As Long, ByVal vUsuarioid As Long, ByVal vCaja As String) As DataTable
            Dim TempList As New DataTable
            Dim oSP As New clsStored_Procedure("inventarios.paingreso_mercaderia_transferencia")
            Dim oConexion As New clsConexion
            Try
                oSP.addParameter("vcodigo", vCodigo, NpgsqlTypes.NpgsqlDbType.Integer, 4, ParameterDirection.Input)
        ...
        Public Shared Function Modificar(ByRef objIM As ingreso_mercaderia, ByVal vCodigo As Long, ByVal myArr As String) As DataTable
            Dim vCadena As String = ""

            Try
                vCadena = "select * from paingreso_mercaderia_actualizar(false,"
        ...
        Public Shared Function Leer_Items(ByVal vCodigo As Long) As DataTable
            Dim TempList As New DataTable
            Dim oSP As New clsStored_Procedure("inventarios.paingreso_mercaderia_leer_items")
            Dim oConexion As New clsConexion
            Try
                oSP.addParameter("vcodigo", vCodigo, NpgsqlTypes.NpgsqlDbType.Integer, 4, ParameterDirection.Input)
        ...
        Public Shared Function Consulta_Ingresos(ByVal vAlmacen As Integer, ByVal vSigno As String, ByVal vCliente As Long, ByVal vdocumento As Integer, _
            ...
            Dim TempList As New DataTable
            Dim oSP As New clsStored_Procedure("inventarios.paconsulta_Ingresos")
            Dim oConexion As New clsConexion
            Try
        ...
        Public Shared Function Leer_Tipo_Documentos(ByVal vCodigo_Movimiento As Integer, ByVal vModulo As Integer) As DataTable
            ...
            Dim TempList As New DataTable
            Dim oSP As New clsStored_Procedure("inventarios.padetalle_movimiento_mercaderia_leer_documentos")
            Dim oConexion As New clsConexion
            Try
