...
Namespace Dal
  Public Class depositocolpwebBD
    Public Shared Function Leer_Deposito_Pendiente(ByVal vCampania As Integer, ByVal vAlmacen As Integer, ByVal vPersona As Long,
                                                   ByVal vDesde As String, ByVal vHasta As String) As DataTable
      Dim TempList As New DataTable
      Dim oSP As New clsStored_Procedure("colportaje.padeposito_pendiente_leer")
      ...
      Try
        ...
        oSP.addParameter("vasistenteid", vPersona, NpgsqlTypes.NpgsqlDbType.Integer, 4, ParameterDirection.Input)
    ...
    Public Shared Function Cambiar_Cerrado(ByVal vCodigo As Long, ByVal vUsuario As Long, ByVal vCaja As String) As DataTable
      Dim TempList As New DataTable
      Dim oSP As New clsStored_Procedure("colportaje.padeposito_cambiar_cerrado")
      Dim oConexion As New clsConexion
      Try
        oSP.addParameter("vid", vCodigo, NpgsqlTypes.NpgsqlDbType.Integer, 4, ParameterDirection.Input)
