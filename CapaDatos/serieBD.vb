...
Namespace Dal
    ...
    Public Class serieBD
        ...
        Public Shared Function GetItem(ByVal codigo As Integer) As serie
            ...
            Dim oSP As New clsStored_Procedure("paserie_getrow")
        ...
        Public Shared Function GetList(ByVal descripcion As String) As DataTable
            Dim TempList As New DataTable
            Dim oSP As New clsStored_Procedure("paserie_consulta")
            Dim oConexion As New clsConexion
            Try
        ...
        Public Shared Function GetList(ByVal cod_Emp As Integer, ByVal cod_Doc As Integer) As DataTable
            Dim TempList As New DataTable
            Dim oSP As New clsStored_Procedure("basic.paserie_leer")
            Dim oConexion As New clsConexion
            Try
                oSP.addParameter("incod_doc", cod_Doc, NpgsqlTypes.NpgsqlDbType.Integer, 4, ParameterDirection.Input)
                oSP.addParameter("incod_emp", cod_Emp, NpgsqlTypes.NpgsqlDbType.Integer, 4, ParameterDirection.Input)
                TempList = oConexion.Ejecutar_Consulta(oSP)
                oConexion.Cerrar_Conexion()
            Finally
                oConexion = Nothing
