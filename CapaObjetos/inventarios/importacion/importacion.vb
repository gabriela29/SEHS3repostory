...
Namespace BO
    Public Class importacion
        ...
        Private mimportacionid As Long = -1
        Private maniodua As Integer
        Private maduanaid As Integer
        ...
        Public Property importacionid() As Long
            Get
                Return mimportacionid
            End Get
            Set(ByVal value As Long)
                mimportacionid = value
            End Set
        End Property

        Public Property aniodua() As Integer
            Get
                Return maniodua
            End Get
        ...
        Public Property aduanaid() As Integer
            Get
                Return maduanaid
            End Get
            Set(ByVal value As Integer)
